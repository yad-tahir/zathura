...
#define INCREMENTAL_SEARCH false
  ...
  bool_value = false;
  girara_setting_add(gsession, "window-title-progress",  &bool_value,  BOOLEAN, false, _("Display the page number in percentage in the window title"), cb_window_statbusbar_changed, NULL);
  bool_value = false;
